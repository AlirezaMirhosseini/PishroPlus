  ...
  methods: {
    ...
    async getInvoiceList() {
      try {
        ...
        if (res.isSuccess) {
          this.returnedSaleInvoices = res.value.result.map((x) => {
            return {
              ...x,
        ...
        console.error('Error fetching return sale invoices:', error)
